...
function App() {
  ...
  <a name= "Home"><div className='md:flex mt-auto my-auto'>
   ...
   <p></p>
        ...
        <h2 className=' text-[min(3vw,30px)]'>第二回京王線スポット総選挙に出ていた観光スポットを絡めた13個のコースをご紹介します。おおよその所要時間と特典について記載しているので、休みの日や大学の授業の空きコマ等に電車で遊びに行ってみては?</h2>
        <p></p>
        <p></p>
        <ol className='border-solid border-2 border-gray-300 text-cyan-700 text-[min(3vw,30px)] ' >
            <li><a href="#spot1" className='hover:underline hover:text-cyan-900 duration-500'>01 長沼公園で心と体をリフレッシュ (長沼駅~京王片倉駅)<br/>
            [約5時間]</a></li>
            <li><a href="#spot2" className='hover:underline hover:text-cyan-900'>02 新鮮な海鮮を食べた後は大迫力の東京競馬場へ！(府中駅)<br/>
            [約3時間]</a></li>
            ...
            [約1時間半:<span className=" font-medium" >特典あり</span>]</a></li>
            <li><a href="#spot5" className='hover:underline hover:text-cyan-900'>05 深大寺、植物園、温泉で喧騒から離れてゆったり (調布駅)<br/>
            [約3時間半]</a></li>
            <li><a href="#spot6" className='hover:underline hover:text-cyan-900'>06 映えるお寺カフェの後は食べ歩き (仙川駅)<br/>
            [約2時間:<span className=' font-medium'>特典あり</span>]</a></li>
            <li><a href="#spot7" className='hover:underline hover:text-cyan-900'>07 映画の撮影地にもなった商店街からのアウトレット! (南大沢駅)<br/>
            [約半日]</a></li>
            <li><a href="#spot8" className='hover:underline hover:text-cyan-900'>08 ぶどう狩りの後は温泉でお腹も体も大満足 (仙川駅)<br/>
            [約5時間]</a></li>
            <li><a href="#spot9" className='hover:underline hover:text-cyan-900'>09 食べ歩き、お参り、桜の名所! (調布駅)<br/>
            [約1時間半]</a></li>
            <li><a href="#spot10" className='hover:underline hover:text-cyan-900'>10 よみうりランドとHANA・BIYORIで一日中遊べる (京王よみうりランド駅)<br/>
            [約半日]</a></li>
            ...
            [約2時間:<span className=' font-medium'>特典あり</span>]</a></li>
            <li><a href="#spot13" className='hover:underline hover:text-cyan-900'>13 内海果樹園の野菜を使った料理で健康的なご飯！ (八幡山駅)<br />
            [約2時間:<span className=' font-medium'>特典あり</span>]</a></li>
            <p></p>
            <p></p>
        </ol>
        <h2><a name = "spot1"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>01 長沼公園で心と体をリフレッシュ <br/>(長沼駅~京王片倉駅)[約5時間]</div>
        <p  className='text-[min(5vw,50px)] underline decoration-red-200'>[東京都立長沼公園 → 鎌田鳥山 → 竜泉寺の湯八王子みなみ野店]</p></a></h2>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:長沼公園]</span><br/>
            <p></p>
            ...
            <p></p>
            <h2><a name = "spot2"><div id = "spots"  className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>02 新鮮な海鮮を食べた後は大迫力の東京競馬場へ！<br/>(府中駅)[約3時間]</div>
            <p className='text-[min(5vw,50px)] underline decoration-red-200'>[大東京綜合卸売センター → 東京競馬場]</p></a></h2>
        <img src="卸売り.jpeg"  className=' object-cover h-[20rem]  md:h-[40rem] w-full  md:w-2/3'/><br/>
        <h3 className=' text-[min(3vw,30px)]'>午前に新鮮な海鮮を食べて、馬券を買わなくても楽しめる東京競馬場へ！</h3>
        <img src="競馬.jpeg"  className=' w-full  md:w-2/3'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:大東京綜合卸売センター]</span>
            <p></p>
            <p>住所:東京都府中市矢崎町4-1</p>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:東京競馬場]</span><br/>
            <p></p>
            <p>住所:東京都府中市日吉町１−１</p>
            ...
            <h2><a name = "spot3"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>03 温泉で体を洗い流した夜はキャンプ <br/>(高尾山口駅~高尾駅)[宿泊]</div>
            <p className='text-[min(5vw,50px)] underline decoration-red-200'>[京王高尾山温泉 極楽湯 → TAKAO CAMP PARK -RAFT-]</p></a></h2>
        <img src="キャンプ1.jpeg"  className=' object-cover w-full  md:w-2/3 md:h-[40rem] h-[20rem]'/><br/>
        <h3 className=' text-[min(3vw,30px)]'>体を洗い流した後はキャンプへ！薪割り、ピザ作りなどの様々なアクティビティを楽しむことができます。</h3>
        <img src="キャンプ2.jpeg"  className=' object-cover w-full  md:w-2/3 h-[25rem] md:h-[40rem]'/><br/>
        <h4 className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:TAKAO CAMP PARK -RAFT-]</span><br/>
            <p></p>
            ...
            <h2><a name="spot4"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>04 お洒落な古着&グルメ巡り <br/>(布田駅)[約1時間半:特典あり]</div>
            <p className='text-[min(5vw,50px)] underline decoration-red-200'>[Vintage&Used BYRE → パンケーキ専門店バター&ミルク]</p></a></h2>
        <img src="BYRE1.jpeg"  className=' object-cover w-full  md:w-2/3 md:h-[40rem] h-[20rem]' /><br/>
        <h3 className=' text-[min(3vw,30px)]'>牛舎を改装して作られたおしゃれな店内の古着屋を見た後はパンケーキを食べて一休み！</h3><br/>
        <img src="BYRE2.jpeg"  className=' object-cover w-full  md:w-2/3 md:h-[40rem] h-[25rem]'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:Vintage&Used BYRE]</span><br/>
            <p></p>
        ...
        <img src="天然温泉.jpg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:深大寺]</span><br/>
            <p></p>
        ...
        <h4 className="border-solid border-2 border-gray-300  text-[min(3vw,30px)]"><span className=' font-medium'>[infomation:神代植物公園]</span><br/>
                <p></p>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:深大寺天然温泉　湯守の里]</span><br/>
                    <p></p>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:一龍院]</span><br/>
            <p></p>
        ...
        <h2><a name = "spot7"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>07 映画の撮影地にもなった商店街からのアウトレット! <br/>(南大沢駅)[約半日]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[南大沢三丁目商店街 → アウトレットパーク多摩南大沢]</p></a></h2>
        <img src="南大沢1.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:南大沢三丁目商店街]</span><br/>
            <p></p>
            <p>住所:東京都八王子市南大沢3-9-5</p>
            <p>アクセス:京王線「南大沢駅」徒歩１５分</p>
            </h4>
        <h2><a name = "spot8"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>08 ぶどう狩りの後は温泉でお腹も体も大満足 <br/>(仙川駅)[約5時間]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[山内ぶどう園 → 仙川湯けむりの里 → 中華そば　しば田]</p></a></h2>
        <img src="ぶどう1.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h3 className=' text-[min(3vw,30px)]'>山内ぶどう園でぶどう狩りや野菜を採ったをした後は、去年の人気選挙でランクインした温泉に行き、締めのラーメンで体もお腹も大満足！</h3>
        <img src="ぶどう2.jpeg"  className='object-cover object-[center_top] w-full  md:w-2/3 h-[30rem] md:h-[40rem]'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:山内ぶどう園]</span><br/>
            <p></p>
        ...
        <h2><a name = "spot9"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>09 食べ歩き、お参り、桜の名所! <br/>(調布駅)[約1時間半]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[天神通り商店会 → 布多天神社 → ハリウッドの大寒桜]</p></a></h2>
        <img src="天神1.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h3 className=' text-[min(3vw,30px)]'>ゲゲゲの鬼太郎のキャラクターたちを横目に商店街を楽しんだ後は布多天神社でお参り。</h3>
        <h3 className=' text-[min(3vw,30px)]'>帰り道は桜の名所へ！</h3>
        <img src="天神2.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:天神通り商店会]</span><br/>
            <p></p>
        ...
        <h2><a name = "spot10"><div id ="spots" className='text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>10 よみうりランドとHANA・BIYORIで一日中遊べる <br/>(京王よみうりランド駅)[約半日]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[HANA・BIYORI → よみうりランド]</p></a></h2>
        ...
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:HANA・BIYORI]</span><br/>
            <p></p>
        ...
        <h2><a name = "spot11"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>11 古着巡りからの映画コース <br/>(京王多摩センター駅)[約5時間]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[古着屋SAJI → イオンシネマ多摩センター → 喫茶リエート]</p></a></h2>
        ...
        <img src="SAJI2.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h3 className=' text-[min(3vw,30px)]'>一通り楽しんだら映画を見て喫茶でゆったり！古着好きにもおすすめのコースです。</h3>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:古着屋SAJI]</span><br/>
            <p></p>
        ...
        <h2><a name = "spot12"><div id = "spots" className=' text-[min(4vw,40px)] mt-20 border-solid border-2 border-cyan-700 rounded'>12 たくさんの猿を見て癒される! <br/>(高尾山口駅)[約2時間:特典あり]</div>
        <p className='text-[min(5vw,50px)] underline decoration-red-200'>[高尾山さる園・野草園 → 高橋屋]</p></a></h2>
        ...
        <img src="猿2.jpeg"  className=' object-cover w-full  md:w-2/3 h-[20rem] md:h-[40rem]'/><br/>
        <h4  className='border-solid border-2 border-gray-300 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:高尾山さる園・野草園]</span><br/>
            <p></p>
        ...
        <h4  className='border-solid border-2 border-gray-300 mb-14 text-[min(3vw,30px)]'><span className=' font-medium'>[infomation:内海果樹園]</span><br/>
            <p></p>
